...
@testset "CalcDeltaHPrecomputed tests" begin
    ...
    @test_throws ErrorException(
        "plumerise: momentum-dominated deltaH is NaN. stackDiam: 10.0, stackVel: 20.0, windSpeedMinusOnePointFour: NaN",
    ) calcDeltaHPrecomputed(
        1,
        temperature,
        windSpeed,
        sClass,
    ...
    @test_throws ErrorException(
        "plumerise: stable bouyancy-dominated deltaH is NaN. F: 6537.766666666667, s1: 1.0, windSpeedMinusThird: NaN",
    ) calcDeltaHPrecomputed(
        4,
        temperature,
        windSpeed,
    ...
    @test_throws ErrorException(
        "plumerise: unstable bouyancy-dominated deltaH is NaN. F: 6537.766666666667, stackHeight: 100.0, windSpeedInverse: NaN",
    ) calcDeltaHPrecomputed(
        6,
        temperature,
        windSpeed,
...
@testset "ASME tests" begin
    ...
    @test_throws ErrAboveModelTop ASME(
        10.0,
        stackDiam,
        stackTemp,
        stackVel,
...
@testset "ASMEPrecomputed tests" begin
    ...
    @test_throws ErrAboveModelTop ASMEPrecomputed(
        20.0,
        stackDiam,
        stackTemp,
        stackVel,
    ...
    @test_throws ErrorException(
        "plumerise: unstable bouyancy-dominated deltaH is NaN. F: 6537.766666666667, stackHeight: 60.0, windSpeedInverse: NaN",
    ) ASMEPrecomputed(
        60.0,
        stackDiam,
        stackTemp,
